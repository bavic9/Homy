export const ContactCards = ({ tittle, number, icon, tag}) => {
    return (
        <div className="bg-white space-y-8 rounded-small border-none p-3 shadow-sm shadow-blueIsh/40 transition ease-in-out delay-75 hover:scale-105 hover:shadow-md hover:shadow-blueIsh/50">
