export const ResCard = ({ imageUrl, detail, price, nam}) => {
    return (
        <div className="">
            <div className="h-card pb-5 w-33 border border-transparent transition ease-in-out delay-75 rounded-card mx-auto text-start hover:scale-105 hover:shadow-md hover:shadow-blueIsh/50 hover:bg-blueIshLight">
